...
$resp = $client->orgs admins->updateOrgAdmin($model->toArray());
print_r($resp);
```
...
$resp = $client->orgs admins->inviteOrgAdmin($model->toArray());
print_r($resp);
```
...
$resp = $client->orgs admins->updateOrgAdminInvite($model->toArray());
print_r($resp);
```
