...
$resp = $client->sites psks->createSitePsk($model->toArray());
print_r($resp);
```
...
$resp = $client->sites psks->updateSiteMultiplePsks($model->toArray());
print_r($resp);
```
...
$resp = $client->sites psks->importSitePsks($model->toArray());
print_r($resp);
```
...
$resp = $client->sites psks->updateSitePsk($model->toArray());
print_r($resp);
```
