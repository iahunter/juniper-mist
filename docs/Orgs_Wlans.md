...
$resp = $client->orgs wlans->createOrgWlan($model->toArray());
print_r($resp);
```
...
$resp = $client->orgs wlans->updateOrgWlan($model->toArray());
print_r($resp);
```
...
$resp = $client->orgs wlans->uploadOrgWlanPortalImage($model->toArray());
print_r($resp);
```
...
$resp = $client->orgs wlans->updateOrgWlanPortalTemplate($model->toArray());
print_r($resp);
```
