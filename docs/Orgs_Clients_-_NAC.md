...
|---|---|---:|---|---|
|`distinct`|query|false|`#/components/schemas/org_nac_clients_count_distinct`|NAC Policy Rule ID, if matched|
...
|`mdm_provider`|query|false|`string`|MDM provider of client’s organization eg "intune", "jamf"|
|`None`|None|false|``||
|`None`|None|false|``||
|`None`|None|false|``||
|`None`|None|false|``||
...
|name|in|required|type|description|
|---|---|---:|---|---|
|`distinct`|query|false|`#/components/schemas/org_nac_client_events_count_distinct`||
|`None`|None|false|``||
|`None`|None|false|``||
|`None`|None|false|``||
|`None`|None|false|``||
...
|`auth_type`|query|false|`string`|Authentication type, e.g. "eap-tls", "eap-peap", "eap-ttls", "eap-teap", "mab", "psk", "device-auth"|
|`vlan`|query|false|`integer`|Vlan name or ID assigned to the client|
...
|`resp_attrs`|query|false|`#/components/schemas/resp_attrs`|Radius attributes returned by NAC to NAS derive|
...
|`ssid`|query|false|`string`|SSID|
|`status`|query|false|`#/components/schemas/nac_client_last_status`|Connection status of client i.e "permitted", "denied, "session_stared", "session_ended"|
